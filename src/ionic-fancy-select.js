  ...
  return {
    ...
    template: function(element, attrs) {
      if (attrs.templateUrl) {
        ...
        return '<ion-list> <ion-item ng-click=showItems($event) ng-disabled="fsDisabled()"> {{text}} <span class=item-note>{{noteText}} <img class={{noteImgClass}} ng-if="noteImg != null" ng-src="{{noteImg}}"/> </span> </ion-item> </ion-list>';
      }
    },
